...
| BastCare 1.0.10 supports saved-summary reading in English, Korean, Simplified Chinese, Vietnamese, Colombian Spanish, Albanian, and German. | Verified live | Beth / Thanh | BastCare source release merge `00ad77c346cf9bbc3cfeb4eb3e86e7d4daa2c142`; Apple's live U.S. product page reported Version 1.0.10 on 2026-09-19, including German, Albanian, and How This Summary Was Made. The legacy lookup API lagged behind the product page during propagation. |
